                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 p-4 sm:p-6 lg:p-8">
                        ...
                        <div>
                            ...
                            <div className="flex items-center text-gray-700 text-sm mb-6">
                                ...
                                <img src={event.user.avatar} alt={event.user.name} className="w-6 h-6 rounded-full mr-1" />
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center">
                                        <img
                                            ...
                                            onError={(e) => { e.currentTarget.src = 'https://placehold.co/64x64/cccccc/333333?text=user'; }}
                                        />
                                        <div>
                                            <p className="text-lg font-semibold text-gray-900">{event.user.name}</p>
                                            <p className="text-sm text-gray-600 flex items-center">
                                                {/* {event.user.reviews} Reviews |
                                                <Star className="w-3 h-3 ml-1 text-yellow-500 fill-yellow-500" /> {event.user.rating} */}
                                                {/* {event.user.responsiveness && <span className="ml-1">• {event.user.responsiveness}</span>} */}
                                            </p>
                                        </div>
                                    </div>
                                    <div className="flex space-x-2">
                                        <button className="px-4 py-1 outline outline-green-700 rounded-sm hover:bg-green-100 text-green-700 transition duration-300 shadow-md text-sm">
                                            Contact {event.user.name.split(' ')[0]}
                                        </button>
                                    </div>
                                </div>
                            </div>
