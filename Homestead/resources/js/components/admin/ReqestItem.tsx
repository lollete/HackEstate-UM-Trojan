...
const RequestListItem: React.FC<RequestListItemProps> = ({ request, isActive, onClick }) => (
    <div
        className={`flex items-center space-x-3 p-4 border-b cursor-pointer transition-colors duration-200 ${isActive ? 'bg-green-50 border-green-200' : 'bg-white hover:bg-gray-50'
            }`}
