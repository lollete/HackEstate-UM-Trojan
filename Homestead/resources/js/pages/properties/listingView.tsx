...
import { type BreadcrumbItem, type Property } from '@/types'; // Import Property from '@/types'
...
const ListingView: React.FC = () => {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        {
            title: 'Listings',
            href: '/view', // You might want to adjust this to a general listings page
        },
        {
            title: property ? property.name : 'Property Details', // Dynamic title
    ...
    useEffect(() => {
        ...
        // The ID is expected to be the last segment, e.g., /Property/1 -> '1'
        const id = pathSegments[pathSegments.length - 1];

        if (id) {
            // Find the property in the imported data
    ...
    if (!property) {
        return (
            <AppLayout breadcrumbs={breadcrumbs}>
                <Head title="No Property Selected" />
                <div className="flex items-center justify-center min-h-screen bg-gray-100">
                    <p className="text-lg text-gray-700">Select a property to view its details.</p>
                </div>
            </AppLayout>
        );
    }
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            {/* Set the page title dynamically based on the property name */}
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 p-4 sm:p-6 lg:p-8">
                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="space-x-2 flex flex-row">
                                {/* Small image gallery - using placeholders for now */}
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 text-gray-700 text-sm mb-6">
                                <div className="flex items-center">
                                    ...
                                    <span>Built in 2005</span> {/* Placeholder for built year */}
                                </div>
                                <div className="flex items-center">
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-600 flex items-center">
                                                5 Reviews |<Star className="w-3 h-3 ml-1 text-yellow-500 fill-yellow-500" /> 4.5
                                            </p>
                                        </div>
                                    </div>
                    ...
                    <div className="p-4 sm:p-6 lg:p-8 border-t border-gray-200 mt-6">
                        ...
                        {activeTab === 'details' && (
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                {/* Bedrooms & Bathrooms */}
                                {property.details && property.details.bedroomsAndBathrooms && (
                                    <div>
