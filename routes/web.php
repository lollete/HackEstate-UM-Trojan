...
// Route::get('/buy', [LandingController::class, 'show'])->name('agent.profile');
Route::get('/buy', [LandingController::class, 'Buy'])->name('landing.buy');
Route::get('/rent', [LandingController::class, 'Rent'])->name('landing.rent');
Route::get('/events', [LandingController::class, 'Events'])->name('landing.events');
Route::get('/agents', [LandingController::class, 'Agents'])->name('landing.agents');
Route::get('/contactUs', [LandingController::class, 'ContactUs'])->name('landing.contactUs');
